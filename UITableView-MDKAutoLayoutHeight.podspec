#
#  Be sure to run `pod spec lint UITableView-MDKAutoLayoutHeight.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "UITableView-MDKAutoLayoutHeight"
  s.version      = "0.0.1"
  s.summary      = "A high performance, low invasive height calculation and Cache Tool for UITableview"
  ...
  s.source       = { :git => "https://github.com/miku1958/UITableView-MDKAutoLayoutHeight.git", :tag => s.version }
